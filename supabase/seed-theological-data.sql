-- ==============================================
-- Seed data: theological_profiles + corpus_documents
-- Spustit v novém Supabase → SQL Editor
-- ==============================================

-- 1. Theological profile (CČSH)
INSERT INTO public.theological_profiles (slug, name, content)
VALUES (
  'ccsh',
...
-- 2. Corpus document (Základy víry)
INSERT INTO public.corpus_documents (profile_slug, title, category, content, sort_order, is_active)
VALUES (
  'ccsh',
  'Základy víry CČSH',
  'věrouka',
...
-- 3. Ověření
SELECT 'theological_profiles' as tabulka, count(*) as pocet FROM public.theological_profiles
UNION ALL
SELECT 'corpus_documents', count(*) FROM public.corpus_documents
UNION ALL
SELECT 'postily', count(*) FROM public.postily;
